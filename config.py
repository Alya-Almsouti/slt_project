...
# label paths
train_label_paths = {
                    "CSL_News": "/l/users/amal.saqib/AI702/CSLNews/Filtered_CSL_News_Labels.json",
...
# video paths
rgb_dirs = {
            "CSL_News": '/l/users/amal.saqib/AI702/CSLNews/rgb_format',
...
# pose paths
pose_dirs = {
            "CSL_News": '/l/users/amal.saqib/AI702/CSLNews/pose_format',
